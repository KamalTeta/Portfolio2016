<?php
	...
	$dkArray = array(
		'sprog' => 'dk',
		'h1' => "Kamal:<br/><i>Multimedie designer.<br/>Webudvikler.</i>",
		'disclaimer' => "Dette er en personlig portefølje side, der bliver ikke tjent nogle penge på indholdet.",
		...
		'metodeTagline' => 'Her er de værktøjer jeg arbejder med',
		'pro' => 'Jeg er kyndig med:',
		'learn' => 'Jeg er i gang med at lære:',
		'used' => 'Jeg har før brugt:',
		'sendBtn' => 'Send',
		'message' => 'Besked',
		'navn' => 'Navn',
		'human' => "Skriv 'Human' hvis du ikke er en bot",
		'afsender' => 'Mail',
		'portText' => array('
			<h3>MindSpark</h3><p>MindSpark projectet var en af de første hjemmesider jeg lavede.<br/><br/>Det var en opgave på Multimedie design studiet, og klienten er et lille produktions selvskab.</p><a href="list/Mindspark" target="_blank">Åben i en ny fane</a>',
	...
	$enArray = array(
		'sprog' => 'en',
		'h1' => "Kamal:<br/><i>Multimedia designer.<br/>Webdeveloper.</i>",
		'disclaimer' => "This is a personal portfolio site, no money is being made from the content.",
		...
		'metodeTagline' => 'These are the tools I work with',
		'pro' => 'I am proficient with:',
		'learn' => 'I am currently learning:',
		'used' => 'I have used:',
		'sendBtn' => 'Send',
		'message' => 'Message',
		'navn' => 'Name',
		'human' => "Type 'Human' if you're not a bot",
		'afsender' => 'E-mail',
		'portText' => array('
			<h3>MindSpark</h3><p>The MindSpark project was one of the first websites I made.<br/><br/>It was an assignment on the Multimedia design course, and the client is a small production company.</p><a href="list/Mindspark" target="_blank">Open in new tab</a>',
